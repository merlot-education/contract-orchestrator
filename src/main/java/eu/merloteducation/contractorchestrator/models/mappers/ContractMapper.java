...
public interface ContractMapper {
    ...
    @Mapping(target = "serviceDescription", expression = "java(contractDto.getOffering().getSelfDescription().path(\"verifiableCredential\").path(\"credentialSubject\").path(\"description\").path(\"value\").textValue())")
    @Mapping(target = "serviceExampleCosts", expression = "java(contractDto.getOffering().getSelfDescription().path(\"verifiableCredential\").path(\"credentialSubject\").path(\"exampleCosts\").path(\"value\").textValue())")
